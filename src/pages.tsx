      ...
      <section className="section contact-main">
        ...
        <form id="contact-form" onSubmit={handleSubmit} aria-busy={status === "sending"}>
          ...
          <div className="form-grid">
            ...
            <label><span>{t("Phone number")} <small className="field-optional">({t("optional")})</small></span><input autoComplete="tel" inputMode="tel" name="phone" type="tel" /></label>
